...
* 💼 Linkedin: [@purv-taparia-220620258](https://www.linkedin.com/in/purv-taparia-220620258)

---

## 🎓 Education

* **Chatrabhuj Narsee School, Mumbai**
    * Student from Nursery (Early Years 1) to Grade 4.
...
| Category | Details |
| :--- | :--- |
| **Languages** | Python (Intermediate), JavaScript (basic), HTML, CSS, C++ (Basic) |
...
* High Quality image generation using advanced tools such as Nano Banana Pro and Imagen 4.
* Upload ready high quality video content using advanced models such as Veo 3.1.
...
* **Has a personal portfolio on [tapariapurv.github.io](https://tapariapurv.github.io):** A colorful, visual website hosted using Github Pages.
* Published **4+ books on BriBooks**, including *Dubai and a Futuristic City* and *The Tour to Digidream*.
